...
-- Version corrigée - Mode local avec gestion multi-salles et types de séances
...
-- CORRECTION: Modifier table presences SANS ajouter le champ statut qui existe déjà
...
-- Puis modifier la colonne statut existante
ALTER TABLE `presences` 
